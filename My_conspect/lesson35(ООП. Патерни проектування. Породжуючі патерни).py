...
class VictorianChair(Chair):
    def sit(self):
        return 'Ти сидиш на вікторіанському стулі!'
...
class VictorianTable(Table):
    def dine(self):
        return 'Ти вечеряєш за вікторіанським столом'
...
class WoodenHouseBuilder:
    ...
    def _build_roof(self):
        self.house.roof = 'Дерев\'яний дах'

    def _build_door(self):
        self.house.door = 'Дерев\'яні двері'
