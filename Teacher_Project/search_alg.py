...
def binary_search(arr: list, search_item):
    arr.sort()  # для цього алгоритму массив повинен бути відсортований
    ...
    while low <= high and not search_result:
        ...
        middle_index = (low + high) // 2  # знаходимо середину
        item = arr[middle_index]  # дістаємо по індексу середини елемент
