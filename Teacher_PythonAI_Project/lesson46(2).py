...
class HumansManager:  # клас для роботи з БД
...
manager = HumansManager('files\\db.sl3')

# manager.add_human('Sergiy', 10)
# manager.add_human('Petro', 20)
# manager.add_human('Olga', 30)

print(manager.get_all_humans())
print(manager.find_human_by_name('Bob'))
